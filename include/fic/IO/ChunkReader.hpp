...
/// a queue of workers is ready to digest this and spit out hashes.
/// A larger chunk size implies more read time and slightly higher wait time
...
struct Chunk {
  ...
  /// hashing. It's a unique pointer because we want to move the Chunks from the
